...
namespace DarkSystem\Correios\Services;

use DarkSystem\Correios\Contracts\FreteInterface;
use GuzzleHttp\Psr7\Response;
use GuzzleHttp\ClientInterface;
use DarkSystem\Correios\Service;
use DarkSystem\Correios\WebService;
use DarkSystem\Correios\PackageType;

class FreteService implements FreteInterface
{
    /**
